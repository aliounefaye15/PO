...
<body>
    <div class="container-scroller">
                    ...
                    <div class="card-body">
                        ...
                        <form class="forms-responsive"  action="" method="post">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="number" name="txtid">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="inputTexte4" class="col-sm-3 col-form-label">UserName</label>
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="text" name="txtusername">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="inputpassword" class="col-sm-3 col-form-label">MotPass</label>
                                <div class="col-sm-9">
                                    <input type="password" class="form-control" id="text" name="txtpassword">
                                </div>
                            </div>
        ...
        if(isset($_POST['valider'])){
         ...
         $req_add="INSERT INTO utilisateur(Id,UserName,MotPass)
         Values('$id','$username','$password')";
           $resultat=mysqli_query($conecole,$req_add);
           if ($resultat){
            echo '<meta http-equiv="refresh" content="1;url=../tables/Utilisateurs.php" />';
           } else{
