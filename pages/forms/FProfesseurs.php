...
<body>
    <div class="container-scroller">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form class="forms-responsive"  action="" method="post">
                            ...
                            <div class="form-group row">
                                <label for="matiere" class="col-sm-3 col-form-label">adresse</label>
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="matiere" name="txtmatiere">
                                </div>
                            </div>
      ...
      if(isset($_POST['valider'])){
       ...
       $matiere= $_POST['txtmatiere'];
       $niveau= $_POST['cboniveau'];
       $sexe= $_POST['txtsexe'];

       $req_add="INSERT INTO professeur(matricule,Nom,Prenom,Matiere,Niveau,Sexe)
       Values('$matricule','$nom','$prenom','$matiere','$niveau','$sexe')";
         $resultat=mysqli_query($conecole,$req_add);
         if ($resultat){
          echo '<meta http-equiv="refresh" content="1;url=../tables/Professeurs.php" />';
         } else{
